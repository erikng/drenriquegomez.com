        ...
        <?php if ( (!empty($logo)) && (!empty($website1)) ) echo '<tr><td>&nbsp;</td></tr><tr><td border="0"><a href="'.$website1.'" target="_blank"><img src="'.$logo.'" border="0" width="960" /></a></td></tr>'; elseif (!empty($logo)) echo '<tr><td>&nbsp;</td></tr><tr><td border="0"><img src="'.$logo.'" border="0" width="960" /></td></tr>';?>
          <tr>
            <td><table cellpadding="0" cellspacing="0" width="960">
                ...
                <tr>
                  <td width="50%"><table align="center" border="0" cellpadding="0" cellspacing="0"  width="100%" bgcolor="<?php echo $fg_color;?>">
                      ...
                      <tr>
                        ...
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">MLS : </font></td>
                      ...
                      <tr>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Bed : </font></td>
                        <td align="left"><font color="<?php echo $ft_color;?>">&nbsp;<?php echo $bed ?></font></td>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Bath : </font></td>
                      ...
                      <tr>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">SQ. FT. : </font></td>
                        <td align="left"><font color="<?php echo $ft_color;?>">&nbsp;<?php echo $sqft ?></font></td>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Lot Size : </font></td>
              ...
              <table cellspacing="10" cellpadding="0" border="0" bgcolor="<?php echo $fg_color;?>" width="100%" >
                <tr align="center">
