...
<div id="outter_wrapper">
  <div id="inner_wrapper">
    <div id="general">
      <div id="header"><a href="general.php"><img src="../images/title_general.png" alt="" /></a></div>
...
if ((isset($_POST['id']))&&($_POST['id'] != "xxx")){
    ...
    $query="SELECT * FROM general WHERE `id` = ".htmLawed($_POST['id'])."";
...
if (isset($pull_specs['address']))      $address = $pull_specs['address'];
if (isset($pull_specs['city']))         $city = $pull_specs['city'];
if (isset($pull_specs['county']))       $county = $pull_specs['county'];
if (isset($pull_specs['state']))        $state = $pull_specs['state'];
if (isset($pull_specs['location']))     $location = $pull_specs['location'];
...
if ((isset($_POST['delete'])) && (isset($_POST['delete1'])) && (isset($_POST['delete2'])) && ($_POST['id'] !="16") ){
...
$query="DELETE FROM general WHERE `id` = ".htmLawed($_POST['id']);
$result=mysql_query($query);
echo '<script type="text/javascript">/* <![CDATA[ */ window.location = "" /* ]]> */</script>';
}//end isset delete


}// end isset POST['id'] & $_POST['id'] != xxx
...
<form method="post" action="<?php echo $this_site;?>themes/general/result.php" enctype="multipart/form-data" target="preview">
  ...
  <br />
  <br />
  <div class="statistics"><span class="sect_title">Basic Info</span>
    ...
    <input type="text" id="location" name="location" value="<?php if (isset($location)) echo $location; else echo $pre_city;?>" />
    <br />
...
<br />
  ...
  <br />
  <br />
  <div class="description"><span class="sect_title">Hilighted Features</span>
...
<div class="center_images full_width"><div class="success" style="float: right;width: 300px;"><span class="success_title">Tip</span>Pre-Size your images to be 600px wide.<br /><a class='uploader' href="<?php echo $this_site;?>upload_sizer.php?resizer">Use This Resizer If Needed</a></div>
      <div class="full_width">
        <div class="upload_container">
          <label for="image00">Primary : </label>
          <input type="file" name="image00" id="image00" />
          <?php if (!empty($image00)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image00.'" rel="images" class="preview popup" title="Image 00 - '.$image00.'" >'.$image00.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image00" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area00"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image00))) { echo '<img src="" id="image-preview00" class="max_w_h" />'; } elseif (!empty($image00)) {$image00_c = str_replace($image_types,'',$image00);$ext = file_extension($image00);$image00t = $image00_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image00.'" rel="images2" class="preview" title="Image 00 - '.$image00t.'" ><img src="'.$this_site.$upload_path.$image00.'" alt="'.$image00.'" class="max_w_h" /></a>';} ?>
        </div>
        <div class="clear"></div>
        <div class="upload_container">
          <label for="image01">Image 01 : </label>
          <input type="file" name="image01" id="image01" />
          <?php if (!empty($image01)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image01.'" rel="images" class="preview popup" title="Image 01 - '.$image01.'" >'.$image01.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image01" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area01"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image01))) { echo '<img src="" id="image-preview01" class="max_w_h"/>'; } elseif (!empty($image01)) {$image01_c = str_replace($image_types,'',$image01);$ext = file_extension($image01);$image01t = $image01_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image01.'" rel="images2" class="preview" title="Image 01 - '.$image01.'" ><img src="'.$this_site.$upload_path.$image01.'" alt="'.$image01.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image02">Image 02 : </label>
          <input type="file" name="image02" id="image02" />
          <?php if (!empty($image02)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image02.'" rel="images" class="preview popup" title="Image 02 - '.$image02.'" >'.$image02.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image02" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area02"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image02))) { echo '<img src="" id="image-preview02" class="max_w_h"/>'; } elseif (!empty($image02)) {$image02_c = str_replace($image_types,'',$image02);$ext = file_extension($image02);$image02t = $image02_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image02.'" rel="images2" class="preview" title="Image 02 - '.$image02.'" ><img src="'.$this_site.$upload_path.$image02.'" alt="'.$image02.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image03">Image 03 : </label>
          <input type="file" name="image03" id="image03" />
          <?php if (!empty($image03)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image03.'" rel="images" class="preview popup" title="Image 03 - '.$image03.'" >'.$image03.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image03" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area03"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image03))) { echo '<img src="" id="image-preview03" class="max_w_h"/>'; } elseif (!empty($image03)) {$image03_c = str_replace($image_types,'',$image03);$ext = file_extension($image03);$image03t = $image03_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image03.'" rel="images2" class="preview" title="Image 03 - '.$image03.'" ><img src="'.$this_site.$upload_path.$image03.'" alt="'.$image03.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image04">Image 04 : </label>
          <input type="file" name="image04" id="image04" />
          <?php if (!empty($image04)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image04.'" rel="images" class="preview popup" title="Image 04 - '.$image04.'" >'.$image04.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image04" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area04"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image04))) { echo '<img src="" id="image-preview04" class="max_w_h"/>'; } elseif (!empty($image04)) {$image04_c = str_replace($image_types,'',$image04);$ext = file_extension($image04);$image04t = $image04_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image04.'" rel="images2" class="preview" title="Image 04 - '.$image04.'" ><img src="'.$this_site.$upload_path.$image04.'" alt="'.$image04.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image05">Image 05 : </label>
          <input type="file" name="image05" id="image05" />
          <?php if (!empty($image05)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image05.'" rel="images" class="preview popup" title="Image 05 - '.$image05.'" >'.$image05.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image05" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area05"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image05))) { echo '<img src="" id="image-preview05" class="max_w_h"/>'; } elseif (!empty($image05)) {$image05_c = str_replace($image_types,'',$image05);$ext = file_extension($image05);$image05t = $image05_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image05.'" rel="images2" class="preview" title="Image 05 - '.$image05.'" ><img src="'.$this_site.$upload_path.$image05.'" alt="'.$image05.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image06">Image 06 : </label>
          <input type="file" name="image06" id="image06" />
          <?php if (!empty($image06)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image06.'" rel="images" class="preview popup" title="Image 06 - '.$image06.'" >'.$image06.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image06" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area06"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image06))) { echo '<img src="" id="image-preview06" class="max_w_h"/>'; } elseif (!empty($image06)) {$image06_c = str_replace($image_types,'',$image06);$ext = file_extension($image06);$image06t = $image06_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image06.'" rel="images2" class="preview" title="Image 06 - '.$image06.'" ><img src="'.$this_site.$upload_path.$image06.'" alt="'.$image06.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image07">Image 07 : </label>
          <input type="file" name="image07" id="image07" />
          <?php if (!empty($image07)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image07.'" rel="images" class="preview popup" title="Image 07 - '.$image07.'" >'.$image07.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image07" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area07"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image07))) { echo '<img src="" id="image-preview07" class="max_w_h"/>'; } elseif (!empty($image07)) {$image07_c = str_replace($image_types,'',$image07);$ext = file_extension($image07);$image07t = $image07_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image07.'" rel="images2" class="preview" title="Image 07 - '.$image07.'" ><img src="'.$this_site.$upload_path.$image07.'" alt="'.$image07.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image08">Image 08 : </label>
          <input type="file" name="image08" id="image08" />
          <?php if (!empty($image08)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image08.'" rel="images" class="preview popup" title="Image 08 - '.$image08.'" >'.$image08.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image08" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area08"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image08))) { echo '<img src="" id="image-preview08" class="max_w_h"/>'; } elseif (!empty($image08)) {$image08_c = str_replace($image_types,'',$image08);$ext = file_extension($image08);$image08t = $image08_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image08.'" rel="images2" class="preview" title="Image 08 - '.$image08.'" ><img src="'.$this_site.$upload_path.$image08.'" alt="'.$image08.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image09">Image 09 : </label>
          <input type="file" name="image09" id="image09" />
          <?php if (!empty($image09)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image09.'" rel="images" class="preview popup" title="Image 09 - '.$image09.'" >'.$image09.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image09" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area09"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image09))) { echo '<img src="" id="image-preview09" class="max_w_h"/>'; } elseif (!empty($image09)) {$image09_c = str_replace($image_types,'',$image09);$ext = file_extension($image09);$image09t = $image09_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image09.'" rel="images2" class="preview" title="Image 09 - '.$image09.'" ><img src="'.$this_site.$upload_path.$image09.'" alt="'.$image09.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image10">Image 10 : </label>
          <input type="file" name="image10" id="image10" />
          <?php if (!empty($image10)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image10.'" rel="images" class="preview popup" title="Image 10 - '.$image10.'" >'.$image10.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image10" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area10"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image10))) { echo '<img src="" id="image-preview10" class="max_w_h"/>'; } elseif (!empty($image10)) {$image10_c = str_replace($image_types,'',$image10);$ext = file_extension($image10);$image10t = $image10_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image10.'" rel="images2" class="preview" title="Image 10 - '.$image10.'" ><img src="'.$this_site.$upload_path.$image10.'" alt="'.$image10.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image11">Image 11 : </label>
          <input type="file" name="image11" id="image11" />
          <?php if (!empty($image11)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image11.'" rel="images" class="preview popup" title="Image 11 - '.$image11.'" >'.$image11.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image11" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area11"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image11))) { echo '<img src="" id="image-preview11" class="max_w_h"/>'; } elseif (!empty($image11)) {$image11_c = str_replace($image_types,'',$image11);$ext = file_extension($image11);$image11t = $image11_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image11.'" rel="images2" class="preview" title="Image 11 - '.$image11.'" ><img src="'.$this_site.$upload_path.$image11.'" alt="'.$image11.'"class="max_w_h" /></a>';} ?>
        </div>
        <div class="upload_container">
          <label for="image12">Image 12 : </label>
          <input type="file" name="image12" id="image12" />
          <?php if (!empty($image12)) { echo '<span class="span_current" >Current : <a href="'.$this_site.$upload_path.$image12.'" rel="images" class="preview popup" title="Image 12 - '.$image12.'" >'.$image12.'</a></span> <span class="remove_cbox">(remove<input type="checkbox" name="r_image12" value="1" class="small_cbox"/>)</span>'; } ?>
        </div>
        <div class="preview_area" id="preview-area12"><span>preview</span>
          <?php if ((is_firefox()) && (empty($image12))) { echo '<img src="" id="image-preview12" class="max_w_h"/>'; } elseif (!empty($image12)) {$image12_c = str_replace($image_types,'',$image12);$ext = file_extension($image12);$image12t = $image12_c.'_2.'.$ext.'';echo '<a href="'.$this_site.$upload_path.$image12.'" rel="images2" class="preview" title="Image 12 - '.$image12.'" ><img src="'.$this_site.$upload_path.$image12.'" alt="'.$image12.'"class="max_w_h" /></a>';} ?>
        </div>
      </div>
      <div class="clear"></div>
    </div>
  ...
  <div class="templates"><span class="sect_title">Template</span>
    <div id="temp_holder" >
      ...
      <div class="temp_shell">
        <div class="temp_box">
          <label for="temp1"><img src="../images/temp_1.png" /></label>
        </div>
