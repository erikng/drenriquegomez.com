                ...
                <tr>
                  <td width="50%"><table align="center" border="0" cellpadding="0" cellspacing="0"  width="100%" bgcolor="<?php echo $fg_color;?>">
                    ...
                    <table width="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="<?php echo $fg_color;?>">
                      <tr>
                        <td colspan="3" align="center"><font color="<?php echo $hl_color;?>" size="6">Features</font></td>
                      </tr>
                      <tr>
              ...
              <table cellspacing="10" cellpadding="0" border="0" bgcolor="<?php echo $fg_color;?>">
                <tr align="center">
                  <td width="250"><?php if (!empty($image01)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image01;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image01."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image02)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image02;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image02."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image03)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image03;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image03."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image04)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image04;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image04."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image05)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image05;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image05."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image06)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image06;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image06."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                </tr>
                <tr align="center">
                  <td width="250"><?php if (!empty($image07)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image07;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image07."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image08)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image08;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image08."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image09)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image09;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image09."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image10)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image10;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image10."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image11)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image11;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image11."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                  <td width="250"><?php if (!empty($image12)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image12;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image12."&radius=".$radius."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                </tr>
                <tr>
                  <td colspan="6" align="center"><font color="<?php echo $hl_color;?>" size="6" align="center"><?php echo $title;?></font></td>
                </tr>
                <tr>
                  <td colspan="6"><font color="<?php echo $ft_color;?>"><?php echo $descr;?></font></td>
                </tr>
              </table>
