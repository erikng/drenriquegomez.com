          ...
          <tr>
            <td><table cellpadding="0" cellspacing="0" width="960">
              ...
              <table border="0" cellpadding="0" cellspacing="10" width="100%" bgcolor="<?php echo $fg_color;?>">
                <tr>
                  <td width="50%" rowspan="4"><?php if (!empty($image00)) {?>
                    ...
                    <?php } ?></td>
                  <td width="50%"><table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="<?php echo $fg_color;?>">
                      <tr>
              ...
              <table width="100%" cellspacing="10" cellpadding="0" border="0" bgcolor="<?php echo $fg_color;?>">
                <tr>
                  <td colspan="6" align="center"><font color="<?php echo $hl_color;?>" size="6"><?php echo $title;?></font></td>
                </tr>
                <tr>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="<?php echo $bg_color;?>">
                ...
                <tr align="center" height="35" valign="bottom">
                  <td width="33%" bgcolor="<?php echo $fg_color;?>" ><a href="<?php echo $website1;?>"><font color="<?php echo $hl_color;?>">Visit Our <?php echo $pre_p_company;?> Website</font></a></td>
                  <td width="33%" bgcolor="<?php echo $fg_color;?>" ><a href="<?php echo $website2;?>"><font color="<?php echo $hl_color;?>">Learn More About <?php echo $pre_p_company;?></font></a></td>
                  <td width="33%" bgcolor="<?php echo $fg_color;?>" ><a href="<?php echo $website3;?>"><font color="<?php echo $hl_color;?>">Contact <?php echo $pre_p_company;?></font></a></td>
                </tr>
                <?php } ?>
                <tr>
