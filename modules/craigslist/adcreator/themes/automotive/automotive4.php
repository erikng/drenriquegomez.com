                ...
                <tr>
                  <td width="50%"><table align="center" border="0" cellpadding="0" cellspacing="0"  width="100%" bgcolor="<?php echo $fg_color;?>">
                      ...
                      <tr>
                        ...
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">VIN / Stock : </font></td>
                        <td align="left"><font color="<?php echo $ft_color;?>">&nbsp;<?php echo $vin ?></font></td>
                      </tr>
                      <?php } ?>
                      <?php if ((!empty($make)) || (!empty($model))) { ?>
                      <tr>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Make : </font></td>
                        <td align="left"><font color="<?php echo $ft_color;?>">&nbsp;<?php echo $make ?></font></td>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Model : </font></td>
                        <td align="left"><font color="<?php echo $ft_color;?>">&nbsp;<?php echo $model ?></font></td>
                      </tr>
                      <?php } ?>
                      <?php if ((!empty($miles)) || (!empty($transmission))) { ?>
                      <tr>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Miles : </font></td>
                        <td align="left"><font color="<?php echo $ft_color;?>">&nbsp;<?php echo $miles ?></font></td>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Transmission : </font></td>
                      ...
                      <tr>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Fuel : </font></td>
                        <td align="left"><font color="<?php echo $ft_color;?>">&nbsp;<?php echo $fuel ?></font></td>
                        <td width="" align="right"><font color="<?php echo $ft_color;?>">Drivetrain : </font></td>
                  ...
                  <td width="50%"><table width="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="<?php echo $fg_color;?>">
                      <tr>
              ...
              <table cellspacing="10" cellpadding="0" border="0" bgcolor="<?php echo $fg_color;?>">
                ...
                <tr align="center">
                  ...
                  <td width="250"><?php if (!empty($image12)) {?>
                    <a href="<?php echo $this_site."imager.php?img=a_".$id."_".$image12;?>" target="slideshow" rel="nofollow" ><img src="<?php echo $this_site."corners.php?src=".$image12."&radius=".($radius*2)."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?><?php echo $this_site."corners.php?src=".$image12."&radius=".($radius*2)."&tl=".$top_l."&tr=".$top_r."&bl=".$bot_l."&br=".$bot_r."&bg=".str_replace('#','',$fg_color);?>" border="0" width="115" alt=""  /></a>
                    <?php } else { echo "&nbsp;"; } ?></td>
                </tr>
              </table>
