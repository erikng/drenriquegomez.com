...
<div id="outter_wrapper">
  <div id="inner_wrapper">
    <div id="realestate">
      <div id="header"><a href="realestate.php"><img src="../images/title_realestate.png" alt="" /></a></div>



<?php
//make select list and find warning/expired listings
...
$i++;
unset($id, $mls, $address, $city, $state, $dates, $o_date, $u_date);
}
echo '</select>';
...
if ((isset($_POST['id']))&&($_POST['id'] != "xxx")){
$query="SELECT * FROM real_estate WHERE `id` = ".htmLawed($_POST['id'])."";
...
if (isset($pull_specs['mls']))         $mls = $pull_specs['mls'];
...
if (isset($pull_specs['zipcode']))     $zipcode = $pull_specs['zipcode'];
if (isset($pull_specs['state']))       $state = $pull_specs['state'];
if (isset($pull_specs['bed']))         $bed = $pull_specs['bed'];
if (isset($pull_specs['bath']))        $bath = $pull_specs['bath'];
if (isset($pull_specs['garage']))      $garage = $pull_specs['garage'];
if (isset($pull_specs['year']))        $year = $pull_specs['year'];
if (isset($pull_specs['sqft']))        $sqft = $pull_specs['sqft'];
if (isset($pull_specs['lotsize']))     $lotsize = $pull_specs['lotsize'];
if (isset($pull_specs['email']))       $email = $pull_specs['email'];
...
$query="DELETE FROM real_estate WHERE `id` = ".htmLawed($_POST['id']);
$result=mysql_query($query);
...
<form method="post" action="<?php echo $this_site;?>themes/realestate/result.php" enctype="multipart/form-data" target="preview">
...
<div class="statistics"><span class="sect_title">Specifications</span>
              <label for="price">Price : </label>
              <input type="text" id="price" name="price" value="<?php if (isset($price)) echo $price; else echo "$";?>" />
              <label for="mls">MLS : </label>
              <input type="text" id="mls" name="mls" value="<?php if (isset($mls)) echo $mls;?>" />
              ...
              <input type="text" id="sqft" name="sqft" value="<?php if (isset($sqft)) echo $sqft; else echo " Sq Ft.";?>" />
              <label for="lotsize">Lot Size : </label>
              <input type="text" id="lotsize" name="lotsize" value="<?php if (isset($lotsize)) echo $lotsize; else echo " Sq Ft.";?>" />
              <br />
              <label for="bed">Bed : </label>
              <input type="text" id="bed" name="bed" value="<?php if (isset($bed)) echo $bed;?>" />
              <label for="bath">Bath : </label>
              <input type="text" id="bath" name="bath" value="<?php if (isset($bath)) echo $bath;?>" />
              <label for="garage">Garage : </label>
              <input type="text" id="garage" name="garage" value="<?php if (isset($garage)) echo $garage;?>" />
              ...
              <br />
              <br />
<div class="description"><span class="sect_title">Property Features</span>
